            ...
            FlatButton(
              ...
              onPressed: () {
                if (_name != null) {
                  ...
                  Navigator.of(context, rootNavigator: true).pop('dialog');
                  key.currentState.showSnackBar(SnackBar(content: Text("O nome da playlist não pode ser vazio!")));
                }
              },
            )
          ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: key,
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return Dismissible(
                            ...
                            child: ListTile(
                              ...
                              trailing: Text(data[playlistName].length.toString() +" Músicas"),
                              onTap: () {
        ...
        : Center(
            child: Text("Você não adicionou nenhuma música a essa playlist ainda."),
          ));
  }
}
            ...
            ? Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Center(
                      child: Text(
                          "Essa playlist está vazia. Comece a adicionar algumas músicas!"),
                    ),
                  ),
                  RaisedButton(
                      ...
                      onDismissed: (direction) {
                        setState(() {
                          ...
                          Scaffold.of(context).showSnackBar(
                              SnackBar(content: Text("Música removida.")));
                        });
                      },
                      child: ListTile(
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (BuildContext context) => PlayingPage(
                                  ...
                                  fileMetaData: playlistMetaData[index][0] !=
                                      ...
                                      : [playlistMetaData[index][0], "desconhecido"],
...
class TrackSelectionState extends State<TrackSelection> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Adicionar músicas a playlist"),
        actions: <Widget>[
          InkWell(
