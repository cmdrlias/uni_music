            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        Text("Lista de reprodução", style: TextStyle(fontSize: 22.0),),
                        Container(
                ...
                Expanded(
                                      ...
                                      Navigator.of(context).push(
                                          MaterialPageRoute(
                                              builder: (BuildContext context) => new PlayingPage(
                                                ...
                                                [musicplayer.queueMetaData[index], "desconhecido"],
                                                backPage: "homePage",
                                              )
                                          )
                                      );
                    ...
                    ) : Padding(padding: EdgeInsets.all(70.0), child: Text("Sua lista está vazia", style: TextStyle(
