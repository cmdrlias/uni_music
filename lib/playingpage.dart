  ...
  void addToPlaylist() {
    ...
    musicplayer.loadPlaylistData().then((data) {
      ...
      AlertDialog dialog  = AlertDialog(
          title: Text("Adicionar música a uma playlist"),
          content: Column(
                ...
                children: <Widget>[
                  musicplayer.playlistNames != null ?
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return Container(
                                  child: ListTile(
                                    ...
                                    trailing: Text("${playlistTracks[index].length}"),
                                    onTap: () {
                                      musicplayer.savePlaylist(musicplayer.playlistNames[index], playlistTracks[index], [widget.fileMetaData[0]]);
                                      Navigator.pop(context);
                                      key.currentState.showSnackBar(SnackBar(content: Text("Música adicionada a playlist")));
                                    },
                                  ),
                      ...
                      ) : Text("Você não tem nenhuma playlist criada ainda."),
                ],
              )
      );
